...
There's a built-in library of standard test functions, and you can have a closer look at their implementations in [cmaj_test_functions.js](https://github.com/SoundStacks/cmajor/tests/cmaj_test_functions.js).
...
If writing your own tests, it's probably helpful to look at how the standard ones are implemented, in [cmaj_test_functions.js](https://github.com/SoundStacks/cmajor/tests/cmaj_test_functions.js).
